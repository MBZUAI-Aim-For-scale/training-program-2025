...
Each major module (`demo_2`, `demo_4_5`, `g42`) includes its own `.devcontainer` to ensure:
...
1. Navigate to the module you plan to work with (`demo_2`, `demo_4_5`, or `g42`).
2. Open the module inside a DevContainer-enabled environment (VS Code recommended).
3. Review and follow any module-specific guidance.
4. Execute training, evaluation, or exploratory workflows as required.
